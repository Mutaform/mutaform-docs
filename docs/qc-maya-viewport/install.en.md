# Installation — QC Maya Viewport

Set it up once; after that Blender offers updates on its own.

## What you need

Blender **5.1** or newer. The version is in the window title, and in
`Help → About Blender`.
...
This add-on does not live in the sidebar. It adds a **sphere icon to the
3D viewport header**, to the right of the shading buttons: the icon turns
the mode on, the arrow beside it opens the menu.
