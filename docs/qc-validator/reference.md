...
!!! warning "Обратите внимание"
    Стадия LP_UVs — особая: только на ней в панели появляются три инструмента осмотра развёртки. На других стадиях их просто нет.
...
*Страница собрана из файла `content/qc-validator.ru.yml`. Снимки сделаны в **Scene QC Validator by Mutaform Studio 1.8.6**.*
