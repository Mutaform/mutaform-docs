...
Studio add-ons for Blender: bake preparation, pre-export scene validation,
studio rendering, a diagnostic viewport, and Maya interchange.
...
<div class="addon-card" markdown>
### [Scene QC Validator](qc-validator/reference.en.md)
A checklist of scene and mesh checks before export. _Reference only for now._
</div>
...
<div class="addon-card" markdown>
### [QC Maya Viewport](qc-maya-viewport/reference.en.md)
Maya-style diagnostic viewport shading. _Reference only for now._
</div>

<div class="addon-card" markdown>
### [QC Bridge Maya ↔ Blender](qc-bridge/reference.en.md)
Scene interchange between Blender and Maya over FBX. _Reference only for now._
</div>
...
New to the studio? Start with the [installation page](install.en.md): add the
repository once and every add-on installs and updates from inside Blender.

## How the docs are organised

Each add-on has two pages.
